...
-- Description:	Recibiendo como parametro el nombre de la tabla se retorna su
--              estructura
-- ==========================================================================
CREATE PROCEDURE spEsquemaTabla
	@tabla nvarchar(50)
AS
BEGIN
	SET NOCOUNT ON;
	...
	ON ind.object_id = c.object_id AND c.column_id = ind.column_id WHERE c.object_id = OBJECT_ID(@tabla) and ind.column_id is not null
